...
# import time
sys.path.append(os.path.abspath("./Updated_Rat_Models_hypertension_stable"))



df_save_name = "./HyperTension_500samples"




PATH_to_MAT = "./Updated_Rat_Models_hypertension_stable/"

filenames = ["Openloop_hypertension_Simulation_24-Jan-2022_06-43-58_15000.mat"]
...
print(np.min(train_df["HR"])) # -0.625
print(np.max(train_df["HR"])) # 0.375
...
print(np.min(train_df["MAP"])) # -0.666
print(np.max(train_df["MAP"])) # 0.334
...
class CardiacModel_Env(Env):
    ...
    def reset(self):
        ...
        print('new w/o exercise, disease')
       

        # self.setpoints = np.array([random.uniform(-0.62, 0.38), random.uniform(-0.67, 0.33)])


    
        
        
        # self.state = np.array([random.uniform(-0.62, 0.38), random.uniform(-0.67, 0.33)])
        ...
        # df.to_csv('sac_len500_new_hypertension_stable_s10.csv')


        df.to_csv('ppo_len500_new_hypertension_stable_s0_32_0r002_clip02_gamma095_vf1_ent0005_new.csv')
...
# model.learn(7000000, save_path = 'trained_model/sac_len500_new_hypertension_stable_s0_64_0lr0005_tau00001_gamma09_new') #7000000
# model.save('trained_model/sac_len500_new_hypertension_stable_s0_64_0lr0005_tau00001_gamma09_new')


model = PPO2(Custompolicy, env, verbose = 1, learning_rate = 0.002, gamma = 0.95, cliprange = 0.2, vf_coef =1, ent_coef = 0.005 )
model.learn(7000000, save_path = 'trained_model/ppo_len500_new_hypertension_stable_s0_32_0r002_clip02_gamma095_vf1_ent0005_new') #12000000
model.save('trained_model/ppo_len500_new_hypertension_stable_s0_32_0r002_clip02_gamma095_vf1_ent0005_new')
