...
# import time
sys.path.append(os.path.abspath("./Updated_Rat_Models_healthy_exercise"))



df_save_name = "./Healthy_WithExercise_500samples"


PATH_to_MAT = "./Updated_Rat_Models_healthy_exercise/"
filenames = ["Openloop_Healthy_Exercise_Simulation_01-Feb-2022_02-59-00_15000.mat"]
...
print('max MAP: ', max(MAP)) #158.0
print('min MAP: ', min(MAP)) #117.3
print('max HR: ', max(HR)) #578.5
print('min HR: ', min(HR)) #309.6
...
print(np.min(train_df["HR"])) # -0.64
print(np.max(train_df["HR"])) # 0.36
...
print(np.min(train_df["MAP"])) # -0.62
print(np.max(train_df["MAP"])) # 0.38
...
class CardiacModel_Env(Env):
    ...
    def reset(self):
        ...
        print('new with exercise, healthy')



        rand_sample = np.random.rand(2,2)

        self.setpoints = np.array([rand_sample[0,0] - 0.64, rand_sample[0,1] - 0.62])
        self.state = np.array([rand_sample[1,0] - 0.64, rand_sample[1,1] - 0.62])
        ...
        self.state1.append(self.state[0])
        self.state2.append(self.state[1])
        self.sp1.append(self.setpoints[0])
        self.sp2.append(self.setpoints[1])
...
# model = sacc_Model(Custompolicy, env, verbose = 1, learning_rate = 0.0001, tau = 0.0005, gamma = 0.9 )
# model.learn(7000000, save_path = 'trained_model/sac_len500_new_healthy_exercise_correct_scale_s50_64_0lr0001_tau00005_gamma09_wholerand') #12000000
# model.save('trained_model/sac_len500_new_healthy_exercise_correct_scale_s50_64_0lr0001_tau00005_gamma09_wholerand')


model = PPO2(Custompolicy, env, verbose = 1, learning_rate = 0.002, gamma = 0.95, cliprange = 0.2, vf_coef =1, ent_coef = 0.005 )
model.learn(5000000, save_path = 'trained_model/ppo_len500_new_healthy_stable_s10_32_0r002_clip02_gamma095_vf1_ent0005_10000') #7000000
model.save('trained_model/ppo_len500_new_healthy_stable_s10_32_0r002_clip02_gamma095_vf1_ent0005_10000')
